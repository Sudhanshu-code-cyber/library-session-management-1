...
const Sidebar = () => {
  return (
      <div className="grid grid-rows-7 gap-4 p-4 md:p-6 lg:p-8">
        <Link
          href="/"
          className="flex gap-3 hover:shadow items-center pl-2 py-3 flex-row rounded-lg hover:scale-105 bg-[#B9E5E8]"
        >
          <RxDashboard className="text-xl text-white" />
          <h2 className="text-base md:text-lg lg:text-xl text-white font-bold font-sans">
            Dashboard
          </h2>
        </Link>
        <Link
        ...
        >
          ...
          <p className="text-base md:text-lg lg:text-xl text-white font-bold font-sans">
            Manage CheckOuts
          </p>
        </Link>
        <div className="flex gap-3 hover:shadow items-center pl-2 py-3 flex-row rounded-lg hover:scale-105 bg-[#B9E5E8]">
          <TbReport className="text-xl text-white" />
          <p className="text-base md:text-lg lg:text-xl text-white font-bold font-sans">
            Reports
          </p>
        </div>
        ...
        <div className="flex gap-3 hover:shadow items-center pl-2 py-3 flex-row rounded-lg hover:scale-105 bg-[#B9E5E8]">
          <RiGitRepositoryPrivateLine className="text-xl text-white" />
          <p className="text-base md:text-lg lg:text-xl text-white font-bold font-sans">
            Roles
          </p>
        </div>
